...
def clean_up(args):
	...
	os.system('cp '+home_folder+'*_XX_*tsv ../'+args.file_prefix)
	os.system('cp '+home_folder+'*_XX_*AA.ORF.fasta ../'+args.file_prefix)
	os.system('cp '+home_folder+'*_XX_*NTD.ORF.fasta ../'+args.file_prefix)
	...
	os.system('mv ../'+args.file_prefix+' ../Finished')
